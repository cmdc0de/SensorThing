...
SensorApp::SensorApp() : SensorEventBus(), TempPressureSensor(){
...
ErrorType SensorApp::onInit() {
	...
	Display.swap();
	TempPressureSensor.init(cmdc0de::BMP280::PRESSURE_SAMPLING::OVERSAMPLING_4X, cmdc0de::BMP280::T_OVERSAMPLING_4X,
			cmdc0de::BMP280::POWER_MODE::NORMAL_MODE, cmdc0de::BMP280::NORMAL_MODE_CYCLE_TIME::MS_1000, cmdc0de::BMP280::FILTER_COEFFICIENT::COEFFICIENT_4);

	return ErrorType();
}

ErrorType SensorApp::onRun() {
	return ErrorType();
}
